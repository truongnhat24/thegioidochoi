                        ...
                        <div class="card" style="border-radius: 15px;">
                            <div class="card-body p-5">
                                ...
                                <form name="register-form" method="POST" action="<?php echo html_helpers::url(
                                    ...
                                    <div class="form-outline">
                                        <input name="data[<?php echo $this->controller; ?>][phone]" type="tel" id="phone" class="form-control form-control-lg" require placeholder="0123-456-789" pattern="[0-9]{4}-[0-9]{3}-[0-9]{3}"/>
                                        <label class="form-label" for="phone">Phone</label>
                                    </div>
                                    <p class="mb-4 error phone-error"></p>
